...
public class ShipwrecksMain {
    ...
    public void Init(FMLPreInitializationEvent event) {
        ...
        if(ShipwreckConfig.getIncludeDivingArmor()) {
            ...
            ModelLoader.setCustomModelResourceLocation(diving_helmet, 0, new ModelResourceLocation(diving_helmet.getRegistryName(), "inventory"));
            ModelLoader.setCustomModelResourceLocation(diving_chest, 0, new ModelResourceLocation(diving_chest.getRegistryName(), "inventory"));
            ModelLoader.setCustomModelResourceLocation(diving_legs, 0, new ModelResourceLocation(diving_legs.getRegistryName(), "inventory"));
            ModelLoader.setCustomModelResourceLocation(diving_boots, 0, new ModelResourceLocation(diving_boots.getRegistryName(), "inventory"));
        }
    }
